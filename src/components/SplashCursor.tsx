...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(canvasEl: HTMLCanvasElement) {
      ...
      const halfFloatTexType: number = isWebGL2
        ...
        : (halfFloat?.HALF_FLOAT_OES ?? glContext.UNSIGNED_BYTE);
      let formatRGBA;
      let formatRG;
      let formatR;
    ...
    function getSupportedFormat(
      ...
      if (!supportRenderTextureFormat(glContext, internalFormat, format, type)) {
        switch (internalFormat) {
          case (glContext as WebGL2RenderingContext).R16F:
          ...
          case (glContext as WebGL2RenderingContext).RG16F:
            return getSupportedFormat(
              glContext,
  ...
  return (
    <div className="pointer-events-none fixed inset-0 z-[5] h-full w-full">
